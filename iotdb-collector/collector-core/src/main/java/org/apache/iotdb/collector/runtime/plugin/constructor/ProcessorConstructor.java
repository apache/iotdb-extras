...
public class ProcessorConstructor extends PluginConstructor {

  public ProcessorConstructor(PluginMetaKeeper pluginMetaKeeper) {
  ...
  public final PipeProcessor reflectPlugin(PipeParameters processorParameters) {
    return (PipeProcessor)
        reflectPluginByKey(
            processorParameters
                .getStringOrDefault("processor", BuiltinPlugin.DO_NOTHING_PROCESSOR.getPluginName())
                .toLowerCase());
  }
}
