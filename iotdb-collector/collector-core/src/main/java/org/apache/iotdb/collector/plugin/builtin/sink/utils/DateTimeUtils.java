...
public class DateTimeUtils {
  ...
  public static final String TIMESTAMP_PRECISION = PipeOptions.TIMESTAMP_PRECISION.value();
  ...
  static {
    switch (PipeOptions.TIMESTAMP_PRECISION.value()) {
      case "us":
      case "microsecond":
  ...
  public static long convertDatetimeStrToLong(String str, ZoneId zoneId) {
    return convertDatetimeStrToLong(
        str, toZoneOffset(zoneId), 0, PipeOptions.TIMESTAMP_PRECISION.value());
  }
  ...
  public static long convertDurationStrToLong(
    ...
    return convertDurationStrToLong(
        currentTime, duration, PipeOptions.TIMESTAMP_PRECISION.value(), convertYearToMonth);
  }
  ...
  public static String convertLongToDate(long timestamp) {
    return convertLongToDate(
        timestamp, PipeOptions.TIMESTAMP_PRECISION.value(), ZoneId.systemDefault());
  }

  public static String convertLongToDate(final long timestamp, final ZoneId zoneId) {
    return convertLongToDate(timestamp, PipeOptions.TIMESTAMP_PRECISION.value(), zoneId);
  }
  ...
  public static TimeDuration constructTimeDuration(String duration) {
    ...
    String currTimePrecision = PipeOptions.TIMESTAMP_PRECISION.value();
    long temp = 0;
