...
public class KafkaSourceConstant {
  ...
  public static final int KAFKA_SOURCE_SESSION_TIMEOUT_MS_DEFAULT_VALUE = 10000;

  public static final String KAFKA_SOURCE_MAX_POLL_RECORDS_KEY = "max.poll.records";
  public static final int KAFKA_SOURCE_MAX_POLL_RECORDS_DEFAULT_VALUE = 500;

  public static final String KAFKA_SOURCE_MAX_POLL_INTERVAL_MS_KEY = "max.poll.interval.ms";
  public static final int KAFKA_SOURCE_MAX_POLL_INTERVAL_MS_DEFAULT_VALUE = 300000;
