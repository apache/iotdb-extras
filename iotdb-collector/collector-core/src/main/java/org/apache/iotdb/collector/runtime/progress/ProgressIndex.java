...
public class ProgressIndex {
  private final Map<String, String> progressInfo;
  private final Integer instanceIndex;

  public ProgressIndex(final Integer instanceIndex, final Map<String, String> progressInfo) {
