 ...
 */
public class JSONPayloadFormatter implements org.apache.iotdb.db.protocol.mqtt.PayloadFormatter {
  ...
  private List<Message> formatJson(JsonObject jsonObject) {
    org.apache.iotdb.db.protocol.mqtt.TreeMessage message = new org.apache.iotdb.db.protocol.mqtt.TreeMessage();
  ...
  private List<Message> formatBatchJson(JsonObject jsonObject) {
    ...
    for (int i = 0; i < timestamps.size(); i++) {
      org.apache.iotdb.db.protocol.mqtt.TreeMessage message = new TreeMessage();
