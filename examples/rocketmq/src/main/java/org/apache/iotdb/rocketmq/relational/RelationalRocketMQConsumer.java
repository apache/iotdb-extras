...
public class RelationalRocketMQConsumer {
  ...
  public RelationalRocketMQConsumer(String producerGroup, String serverAddresses)
  ...
  public static void main(String[] args) throws MQClientException, IoTDBConnectionException {
    RelationalRocketMQConsumer consumer =
        new RelationalRocketMQConsumer(
            RelationalConstant.CONSUMER_GROUP, RelationalConstant.SERVER_ADDRESS);
